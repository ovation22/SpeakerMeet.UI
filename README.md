...
[![Maintainability](https://sonarqube-5xmy4umczrwho.azurewebsites.net/api/project_badges/measure?project=SpeakerMeet.Api&metric=sqale_rating)]([https://yourprojectonsonarqube/dashboard?id=your_project_key](https://sonarqube-5xmy4umczrwho.azurewebsites.net/dashboard?id=SpeakerMeet.UI))
